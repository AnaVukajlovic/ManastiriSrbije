...
downloads = [
    ("jelena-anzujska-2.jpg", "File:Helen of Anjou and her son King Milutin, Gračanica.jpg"),
    ("jelena-anzujska-3.jpg", "File:Краљица Јелена у дворцу Брњацима (Јелена Анжујска, око 1225 - 1314).jpg")
]

for filename, title in downloads:
