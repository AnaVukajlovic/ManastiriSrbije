...
$eparchy_data = [
    ...
    167 => [
        ...
        'images' => [
            [
                ...
                'caption' => 'Crkva Svete Petke u manastiru Bresnica sa prepoznatljivim trolučnim tremom oslikanim freskama' . $src,
                'sort_order' => 1
            ],
        ]
    ],
    ...
    168 => [
        ...
        'images' => [
            [
                ...
                'caption' => 'Srednjovekovna kamena crkva Svetog proroka Ilije iz 13. veka u klisuri Kacapunske reke' . $src,
                'sort_order' => 1
            ],
            [
                'url' => 'images/monasteries/kacapun_gal_1.jpg',
                'caption' => 'Arhivska fotografija crkve Svetog Ilije u Kacapunu sa kamenim krovom u gustoj šumi' . $src,
                'sort_order' => 2
            ],
            [
                'url' => 'images/monasteries/kacapun_gal_2.jpg',
                'caption' => 'Drveni oslikani ikonostas sa carskim dverima i prestonim ikonama u unutrašnjosti hrama' . $src,
                'sort_order' => 3
            ],
            [
                'url' => 'images/monasteries/kacapun_gal_3.jpg',
                'caption' => 'Pogled sa trema konaka sa istaknutim zastavama ka crkvi Svetog Ilije u manastirskoj porti' . $src,
                'sort_order' => 4
            ],
        ]
    ],
    ...
    169 => [
        ...
        'description' => "ISTORIJAT I NASTANAK:\nManastir Lopardince nalazi se na šumovitim padinama planine Rujan, u blizini Bujanovca. Posvećen je Svetom arhangelu Gavrilu (u narodu i Svetom Đorđu). Narodno predanje vezuje njegov nastanak za srednji vek, dok pisani izvori i tragovi obnove svedoče o živom monaškom centru tokom 16. i 17. veka.\n\nARHITEKTURA I UNUTRAŠNJOST:\nCrkva je jednobrodna kamena građevina sa prostranom pripratom i polukružnom apsidom. U unutrašnjosti se nalaze vredni fragmenti fresaka i očuvan ikonostas iz 19. veka, sa ikonama visoke umetničke i zanatske izrade.\n\nDUHOVNI ŽIVOT I ZNAČAJ:\nManastir Lopardince je kroz vekove bio utočište i saborno molitveno mesto srpskog naroda bujanovačkog kraja. U novije vreme hram i manastirski kompleks su obnovljeni, okupljajući mnogobrojne vernike Eparhije vranjske.",
        'images' => [
            [
                'url' => 'images/monasteries/lopardince.jpg',
                'caption' => 'Svečano vodoosvećenje i vaskršnja liturgija ispred crkve u manastiru Lopardince' . $src,
                'sort_order' => 1
            ],
            [
                'url' => 'images/monasteries/lopardince_gal_1.jpg',
                'caption' => 'Verni narod i omladina okupljeni na pričešću i podeli nafore tokom liturgije' . $src,
                'sort_order' => 2
            ],
            [
                'url' => 'images/monasteries/lopardince_gal_2.jpg',
                'caption' => 'Crkveno-narodni sabor i liturgijsko sabranje vernika u manastirskoj porti u Lopardincu' . $src,
                'sort_order' => 3
            ],
            [
                'url' => 'images/monasteries/lopardince_gal_3.jpg',
                'caption' => 'Crkveno pojanje devojaka za pevnicom tokom svete službe u manastiru' . $src,
                'sort_order' => 4
            ],
        ]
    ],
    ...
    170 => [
        ...
        'images' => [
            [
                ...
                'caption' => 'Panoramski pogled na manastirski kompleks Sveti Prohor Pčinjski podno Kozjaka uz reku Pčinju' . $src,
                'sort_order' => 1
            ],
            [
                'url' => 'images/monasteries/prohor-pcinjski_gal_1.jpg',
                'caption' => 'Ilustrovani plan i prikaz objekata kompleksa manastira povodom jubileja 950 godina (1070–2020)' . $src,
                'sort_order' => 2
            ],
            [
                'url' => 'images/monasteries/prohor-pcinjski_gal_2.jpg',
                'caption' => 'Arhivski aerofoto snimak manastirskog kompleksa Prohor Pčinjski sa rasporedom crkve i konaka' . $src,
                'sort_order' => 3
            ],
            [
                'url' => 'images/monasteries/prohor-pcinjski_gal_3.jpg',
                'caption' => 'Istorijski izgled spratnih konaka sa drvenim tremovima i arkadama u porti manastira' . $src,
                'sort_order' => 4
            ],
        ]
    ],
    ...
    171 => [
        ...
        'images' => [
            [
                ...
                'caption' => 'Bela crkva Svetog arhiđakona Stefana sa kupolom, tremom i konakom u manastiru Žapsko' . $src,
                'sort_order' => 1
            ],
            [
                'url' => 'images/monasteries/zapsko_gal_1.jpg',
                'caption' => 'Severna fasada crkve Svetog Stefana sa kupolom, kamenom pripratom i čempresima u porti' . $src,
                'sort_order' => 2
            ],
            [
                'url' => 'images/monasteries/zapsko_gal_2.jpg',
                'caption' => 'Natkriveni kameni letnjikovac sa lukovima i klupama za odmor vernika u porti Žapskog' . $src,
                'sort_order' => 3
            ],
            [
                'url' => 'images/monasteries/zapsko_gal_3.jpg',
                'caption' => 'Rezbareni drveni ikonostas, carske dveri i podni mozaik u unutrašnjosti hrama' . $src,
                'sort_order' => 4
            ],
        ]
    ],
    ...
    240 => [
        ...
        'images' => [
            [
                ...
                'caption' => 'Lučna kamena kapija sa krstom na ulazu u manastirski kompleks Dubnica kod Vranja' . $src,
                'sort_order' => 1
            ],
            [
                'url' => 'images/monasteries/dubnica-milesevska_gal_1.jpg',
                'caption' => 'Prizemni manastirski konak sa drvenim tremom okružen prirodom u Dubnici' . $src,
                'sort_order' => 2
            ],
            [
                'url' => 'images/monasteries/dubnica-milesevska_gal_2.jpg',
                'caption' => 'Staza kroz portu ka drvenom zvoniku, kamenoj crkvi sa strmim krovom i spomen-česmi' . $src,
                'sort_order' => 3
            ],
            [
                'url' => 'images/monasteries/dubnica-milesevska_gal_3.jpg',
                'caption' => 'Drveno-kameni zvonik sa skulpturom svetitelja i crkva u manastirskoj porti Dubnice' . $src,
                'sort_order' => 4
            ],
        ]
    ],
    ...
    246 => [
        ...
        'images' => [
            [
                ...
                'caption' => 'Crkva Preobraženja Gospodnjeg na stenovitom uzvišenju ograđena suvozidom u Kozjem Dolu kod Trgovišta' . $src,
                'sort_order' => 1
            ],
        ]
    ],
    ...
    247 => [
        ...
        'images' => [
            [
                ...
                'caption' => 'Kamena crkva Svetog Pantelejmona, visoki drveni zvonik i stoletno drvo u porti Lepčinca' . $src,
                'sort_order' => 1
            ],
            [
                'url' => 'images/monasteries/lepcince_gal_1.jpg',
                'caption' => 'Istočna fasada i oltarska apsida crkve Svetog Pantelejmona sa pozlaćenim krstom u Lepčincu' . $src,
                'sort_order' => 2
            ],
            [
                'url' => 'images/monasteries/lepcince_gal_2.jpg',
                'caption' => 'Visoki drveni rešetkasti zvonik sa krstom u manastirskoj porti okružen zelenilom' . $src,
                'sort_order' => 3
            ],
            [
                'url' => 'images/monasteries/lepcince_gal_3.jpg',
                'caption' => 'Geografska karta položaja manastira Svetog Pantelejmona u Lepčincu i okolnih svetinja' . $src,
                'sort_order' => 4
            ],
        ]
    ],
    ...
    249 => [
        ...
        'images' => [
            [
                ...
                'caption' => 'Otvoreni drveni trem sa lučnim arkadama na ulazu u crkvu Svetog Simeona Stolpnika u Soderce' . $src,
                'sort_order' => 1
            ],
            [
                'url' => 'images/monasteries/simeon-stolpnik_gal_1.jpg',
                'caption' => 'Zapisno stoletno stablo pored manastirskog poseda Svetog Simeona Stolpnika' . $src,
                'sort_order' => 2
            ],
        ]
    ],
    ...
    251 => [
        ...
        'images' => [
            [
                ...
                'caption' => 'Kamena crkva Uspenja Presvete Bogorodice sa prostranim otvorenim tremom na litici u Mrtvici' . $src,
                'sort_order' => 1
            ],
            [
                'url' => 'images/monasteries/mrtvica_gal_1.jpg',
                'caption' => 'Polukružna oltarska apsida i klesani kameni zidovi crkve sa krovom od kamenih ploča' . $src,
                'sort_order' => 2
            ],
            [
                'url' => 'images/monasteries/mrtvica_gal_2.jpg',
                'caption' => 'Drveni zvonik podignut na samom vrhu visoke strme stene iznad manastira Mrtvica' . $src,
                'sort_order' => 3
            ],
            [
                'url' => 'images/monasteries/mrtvica_gal_3.jpg',
                'caption' => 'Južni kameni trem crkve sa masivnim stubovima, polukružnim lukovima i cvećem' . $src,
                'sort_order' => 4
            ],
        ]
    ],
    ...
    252 => [
        ...
        'images' => [
            [
                ...
                'caption' => 'Drevna crkva Vavedenja Presvete Bogorodice iz 13. veka od lomljenog kamena u šumi kod Surdulice' . $src,
                'sort_order' => 1
            ],
        ]
    ],
    ...
    253 => [
        ...
        'images' => [
            [
                ...
                'caption' => 'Panoramski pogled na crkvu Svetog Nikole sa kupolom i zvonik iznad gradskog jezgra Vranja' . $src,
                'sort_order' => 1
            ],
            [
                'url' => 'images/monasteries/sveti-nikola-vranje_gal_1.jpg',
                'caption' => 'Bela fasada crkve Svetog Nikole sa kupolom, polukružnim lučnim ulazom i pripratom' . $src,
                'sort_order' => 2
            ],
            [
                'url' => 'images/monasteries/sveti-nikola-vranje_gal_2.jpg',
                'caption' => 'Klesana mermerna spomen-ploča o obnovi hrama iz 1905–1906. godine na temeljima Nemanjića' . $src,
                'sort_order' => 3
            ],
            [
                'url' => 'images/monasteries/sveti-nikola-vranje_gal_3.jpg',
                'caption' => 'Stepenište u manastirskoj porti sa visokim četinarima koje vodi ka crkvi Svetog Nikole' . $src,
                'sort_order' => 4
            ],
        ]
    ],
