...
HEADERS = {
    'User-Agent': 'PravoslavniSvetionikBot/1.0 (https://pravoslavnisvetionik.rs; master.rad@example.com)'
}
...
for m in monasteries:
    slug = m['slug']
    print(f"\n==================================================")
    print(f"Processing: {m['name']} ({slug})")
    print(f"==================================================")
    found_files = []
    seen = set()
...
with open(r'd:\projekti\ManastiriSrbije\backend\vranjska_discovered_images.json', 'w', encoding='utf-8') as f:
    json.dump(results, f, ensure_ascii=False, indent=2)

print("\nFinished discovering! Results saved to vranjska_discovered_images.json")
