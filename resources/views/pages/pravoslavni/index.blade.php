...
.ps-page .ps-hero .ps-hero__left .ps-title{
  ...
  text-shadow:0 0 14px rgba(197,162,74,.14) !important;
    ...
    {{-- ZVANIČNI IZVORI I LITERATURA --}}
    @include('partials.sources-card', [
        'title' => 'Zvanični izvori Pravoslavnog Svetionika',
        'sources' => [
            'Српска Православна Црква (СПЦ): <em>Богослужбени календар, Типик и канонско предање</em>',
            'Свето Писмо Старог и Новог Завета (Библија), издање Светог Архијерејског Синода СПЦ',
            'Свети Владика Николај Велимировић: <em>„Охридски пролог”</em> и <em>„Вера Светих”</em>, Ваљево / Београд',
            'Академик Владимир Ћоровић: <em>„Историја српског народа”</em>, Београд, 2001.',
            'Др Радомир Поповић: <em>„Српска Црква у историји”</em>, Православни богословски факултет Универзитета у Београду'
        ],
        'note' => 'Сви духовни, историјски и образовни текстови платформе усклађени су са званичним учењем Српске Православне Цркве и српском историјском науком.'
    ])
