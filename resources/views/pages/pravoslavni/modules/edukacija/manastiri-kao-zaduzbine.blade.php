  ...
  <div class="container">
    ...
    <div class="lesson-grid">
      ...
      <div class="lesson-main">
        ...
        {{-- DOKUMENTARNI VIDEO SADRŽAJI (HISTORYCAST) --}}
        @php
            $moduleVideos = \App\Support\EducationalMedia::forEduModule('manastiri-kao-zaduzbine');
        @endphp
        @if(!empty($moduleVideos) && count($moduleVideos) > 0)
            @include('partials.video-section', [
                'videos' => $moduleVideos,
                'sectionTitle' => '🎬 Video dokumentarci o zadužbinama: Studenica, Dečani i Sopoćani (HistoryCast)'
            ])
        @endif

        {{-- IZVORI I STRUČNA LITERATURA --}}
        @include('partials.edu-sources', [
            'title' => 'Извори и стручна литература за тему „Манастири као задужбине“',
            'sources' => [
                [
                    'author' => 'Републички завод за заштиту споменика културе Србије',
                    'work' => 'Споменичко наслеђе Србије: непокретна културна добра од изузетног значаја',
                    'details' => 'Београд (каталошки подаци, историјат заснивања и архитектонске целине српских манастира).'
                ],
                [
                    'author' => 'Српска академија наука и уметности (САНУ)',
                    'work' => 'Зборници радова Одељења историјских наука о српском средњовековном задужбинарству',
                    'details' => 'Истраживања о ктиторским повељама, правном положају манастирских властелинстава и њиховој друштвеној улози.'
                ],
                [
                    'author' => 'Владимир Ћоровић',
                    'work' => 'Света Гора и Хиландар у средњем веку / Историја српског задужбинарства',
                    'details' => 'Анализа настанка великих царских лаври и њихове духовне мисије.'
                ],
                [
                    'author' => 'Српска Православна Црква (СПЦ)',
                    'work' => 'Шематизам и званични летописи епархија СПЦ (Жичка, Рашко-призренска, Шумадијска, Милешевска)',
                    'details' => 'Подаци о црквеном животу, обнови светиња и историјским задужбинарима.'
                ],
                [
                    'author' => 'Стручни портал Споменици културе у Србији',
                    'work' => 'База непокретних културних добара',
                    'details' => 'Документарни извори за Студеницу, Сопоћане, Високе Дечане, Грачаницу и остале бисере српске баштине.'
                ]
            ],
            'note' => 'Подаци о ктиторима, вековима градње и сакралном значају задужбина усклађени су са документацијом Завода за заштиту споменика културе и САНУ.'
        ])
    </div>
