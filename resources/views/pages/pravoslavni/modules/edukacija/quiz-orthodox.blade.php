...
<section class="section">
  <div class="container">
    ...
    <div class="ps-head">
      <div>
        <h1 class="ps-title">Kviz — Pravoslavlje</h1>
        <p class="ps-sub">Kratka provera osnovnih pojmova i prakse. Posle submit-a dobijaš rezultat i objašnjenje.</p>
      </div>
      <div class="ps-meta">
    ...
    <form method="POST" action="{{ route('edukacija.quiz.orthodox.submit') }}">
      ...
      <div style="margin-top:14px;display:flex;gap:10px;flex-wrap:wrap;">
        ...
        <a class="btn btn--ghost" href="{{ route('edukacija.quiz.orthodox') }}">Reset</a>
      </div>
