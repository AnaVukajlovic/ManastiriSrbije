...
<br><br>
    ...
    {{-- IZVORI I LITERATURA ZA PASHALIJU --}}
    @include('partials.sources-card', [
        'title' => 'Pravoslavni izvori i literatura za Pashaliju',
        'sources' => [
            'Канони Првог васељенског сабора у Никеји (325. године) — <em>Одлука о једнообразном рачунању и слављењу Пасхе</em>',
            'Свети Јован Златоусти: <em>„Пасхална омилија (Слово на Васкрс)”</em>, 4. век',
            'Матеја Властар: <em>„Синтагма (Алфавитни зборник канона)”</em>, 14. век (Одељак о Пасхалном циклусу)',
            'Милутин Миланковић: <em>„Реформа Јулијанског календара”</em>, Свеправославни конгрес у Цариграду, 1923.',
            'Др Радомир Поповић: <em>„Хришћански празници и њихов смисао”</em>, Православни богословски факултет, Београд',
            'Богослужбени Типик и канони Српске Православне Цркве'
        ],
        'note' => 'Сви датуми, формуле и правила за израчунавање Васкрса у потпуности су усклађени са канонима Никејског сабора и званичним календаром Српске Православне Цркве.'
    ])
