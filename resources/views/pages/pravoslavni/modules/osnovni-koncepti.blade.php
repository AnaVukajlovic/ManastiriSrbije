...
<section class="ps-wrap ps-wow">
  <div class="container">
    ...
    @include('partials.sources-card', [
        'title' => 'Izvori i stručna literatura za osnovne koncepte vere',
        'sources' => [
            'Свето Писмо Старог и Новог Завета (Библија), превод Комисије Светог Архијерејског Синода СПЦ',
            'Свети Владика Николај Велимировић: <em>„Вера Светих — Катихизис Источне Православне Цркве”</em>, Београд',
            'Свети Јустин Ћелијски (Поповић): <em>„Догматика Православне Цркве (I–III)”</em>, Манастир Ћелије',
            ...
            'Протојереј др Радомир Поповић: <em>„Појмовник православног богослужења и хришћанског живота”</em>, Православни богословски факултет у Београду',
            'Званична издања и богослужбени приручници Светог Архијерејског Синода Српске Православне Цркве'
        ],
        'note' => 'Сви појмови, тумачења и молитвени текстови темеље се искључиво на канонском предању Српске Православне Цркве и православној догматици.'
    ])
  </div>
</section>
<style>
