  ...
  <div class="container">
    ...
    <div class="auth-shell">
      <div class="auth-hero">
        ...
        <h1 class="auth-hero__title">Napravi svoj nalog</h1>

        <p class="auth-hero__text">
          Registruj se kako bi sačuvala omiljene manastire, koristila edukativne sadržaje,
          AI alate i pristupila dodatnim mogućnostima aplikacije.
        </p>
      ...
      <div class="auth-card">
        <div class="auth-card__head">
          <h2>Registracija</h2>
          <p>Popuni osnovne podatke za kreiranje naloga.</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" class="auth-form">
          ...
          <div class="auth-bottom">
            Već imaš nalog?
            <a class="auth-link" href="{{ route('login') }}">Prijavi se</a>
          </div>
        </form>
      </div>
    </div>
